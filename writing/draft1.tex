...
Mixed Doubles Curling is the product of the International Olympic Committee's
request for a variation of the game that is more fast-paced, dynamic,
high-risk, and less likely to fall into specific patterns determined by a game
strategy \citep{willoughby2005analysis, park2013curling}.
...
and strategic decision-making on the ice. These modifications are intended to
...
traditional game as to how to effectively play the power play. But if there is
...
\begin{figure}[t]
  ...
  \caption{“Top 5 nations by proportion of grouped tasks on the full powerplay
    data.”}
...
draw may be confused with a freeze.
