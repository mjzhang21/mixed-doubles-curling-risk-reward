...
This dataset is compiled from shot-by-shot images which are entered into Curlit's
software and assessed on in a variety of descriptive columns. Includes are measures
like game wins, end results, 

This is the first available dataset for mixed doubles curling that contains, stone-level
...
Chiefly, the data distinguishes power play ends, 
