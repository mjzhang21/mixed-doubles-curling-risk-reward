...
\mz{created three paragraphs without fragments and added more references}
...
in the seventh end. Furthermore, \citep{park2013curling} confirms the advantage
...
minimum samples = 5 were chosen from a grid search. Cluster quality was then
