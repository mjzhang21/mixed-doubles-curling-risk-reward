...
\[
  \begin{aligned}
    \text{behavior\_index}_{i e} =\; & \beta_0
    + \beta_1 \text{PP\_caller}_{i e}
...
clustered at the match level. We estimate the same specification for the mid
and close timing splits.
