...
phase into early-late (shots 16--18) and late-late (shots 19--22) to test
timing mechanisms. Hammer teams throw four late shots and non-hammer teams
throw three, so shares move in discrete increments but standardize exposure
across teams and ends.
...
\mz{Added team offensive defense metrics along with teams with distinct first
shot choice}
