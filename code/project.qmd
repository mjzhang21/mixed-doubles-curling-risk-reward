...
categorical_cols = [
    'competition_id', 'session_id', 'game_id', 'end_id', 'shot_id',
    'team_id', 'player_id', 'task', 'handle', 'timeout',
    'powerplay', 'points',
    'group_id', 'sheet', 
    'noc1', 'noc2', 'lsfe', 'winner', 'team_id1', 'team_id2'
]
...
df[cols_to_fill] = df[cols_to_fill].astype('category')
```
