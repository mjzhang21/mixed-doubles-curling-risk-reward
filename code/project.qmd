...
```
```{python}
df_invalid_player = df[(df["player_id"] == 3)][["match_id"]]
print("player_id = 3:")
print(df_invalid_player)
print("---------------------")
df_invalid_points = df[(df["points"] > 4)][["match_id"]]
print("points > 4:")
print(df_invalid_points)
```
```{python}
df_invalid_matches = df[(df["match_id"] == '22230015_2_3')][["player_id","end_id","result","team_id"]]
df_invalid_matches.sort_values(by='end_id')
```
