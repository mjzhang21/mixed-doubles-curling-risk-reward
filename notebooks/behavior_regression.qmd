...
We read the cleaned stone-level file and standardize the key columns used
throughout the analysis. Tasks are coerced to integers and missing tasks are
set to -1 (neutral/unknown), while other fields are converted to integers where
appropriate. The preview confirms the core identifiers and fields were loaded
correctly.
