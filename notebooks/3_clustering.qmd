...
model = ols('cumulative_score_diff ~ C(task)', data=df_filtered).fit()
...
# Post-hoc pairwise comparisons (Tukey-Kramer)
tukey = pairwise_tukeyhsd(endog=df_filtered['cumulative_score_diff'], groups=df_filtered['task'], alpha=0.05)
