...
def analyze_variable(df, var, group_var, groups_to_use, method="kw", dunn_adjust="holm"):
    ...
    if method == "kw":
        ...
        # Welch ANOVA using statsmodels with robust covariance
        ...
        if pval <= 0.05 and len(groups_to_use) > 1:
            print("Pairwise comparisons (Games-Howell test):")
            gh = pg.pairwise_gameshowell(dv=var, between=group_var, data=df_var)
            print(gh)
...
variables = ['cumulative_score_diff','end_score_diff']
